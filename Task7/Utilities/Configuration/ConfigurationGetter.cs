    ...
    {         
        ...
        public T Get<T>(string param)
        {
            ...
            try 
            {
                ...
                Log.Info($"The param \"{param}\" is writing and has value \"{dynamicVarible}\".");
        ...
        public string ConnectionString(string name)
        {
            ...
            {
                Log.Fatal(ex, $"Unexpected error occurred during getting the connection string \"{name}\" from {ConfigurationData.TestCofigurationFileName}.");
                return null;
            }
        }
